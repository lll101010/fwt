		...
		<div class="container">   
			...
			<div class="blog-agileinfo">
				<div class="col-md-6 col-sm-6 blog-w3lgrids">
					<div class="blog-gridtext">
						<div class="blog-w3img">
							<a href="#myModal" data-toggle="modal"><img src="${ctx }/resource/images/bg1.jpg" class="img-responsive zoom-img" alt=""/></a>
						</div>
				...
				<div class="col-md-6 col-sm-6 blog-w3lgrids">
					<div class="blog-gridtext">
						<div class="blog-w3img">
							<a href="#myModal" data-toggle="modal"><img src="${ctx }/resource/images/bg2.jpg" class="img-responsive zoom-img" alt=""/></a>
						</div>
						<div class="blog-w3imgtext">
			...
			<div class="blog-agileinfo">
				...
				<div class="col-md-4 col-sm-6 blog-w3lgrids">
					<div class="blog-gridtext">
						<div class="blog-w3img">
							<a href="#myModal" data-toggle="modal"><img src="${ctx }/resource/images/g5.jpg" class="img-responsive zoom-img" alt=""/></a>
						</div>
						<div class="blog-w3imgtext">
				...
				<div class="col-md-4 col-sm-6 blog-w3lgrids">
					<div class="blog-gridtext">
						<div class="blog-w3img">
							<a href="#myModal" data-toggle="modal"><img src="${ctx }/resource/images/g6.jpg" class="img-responsive zoom-img" alt=""/></a>
						</div>
						<div class="blog-w3imgtext">
