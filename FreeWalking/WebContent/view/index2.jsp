...
<html>
	...
	<!-- Owl-Carousel-CSS --> <link rel="stylesheet" href="${ctx }/resource/css/owl.carousel.css" type="text/css" media="all">
...
<body onload="startTime()"> 
	...
	<!-- Custom-JavaScript-File-Links -->
		...
		<!-- Weather-Widget-JavaScript -->
			<script src="${ctx }/resource/js/skycons.js"></script>
			<script>
		...
		<!-- Owl-Carousel-JavaScript -->
			<script src="${ctx }/resource/js/owl.carousel.js"></script>
			<script>
